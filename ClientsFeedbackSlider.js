  ...
  render() {
    return (
      ...
      <section className='services-area ptb-100'>
         ...
         <div className="Main-div" style={{marginBottom:"100px"}} >

          
            <h2>
         Our <span class ="color">Partners</span>
            </h2>
         <p style={{marginTop:"30px"}}>
           <a href="https://appsai.com.au/" target="_blank" rel="noopener noreferrer">
         <img src="https://appsai.com.au/images/footer-logo.png" alt="image" />
         </a>
         </p>
          ...
          {this.state.display ? (
            ...
            >
              <div className='single-feedback-item'>
                <img src="/images/clients ptc/1.png" alt="image"  style={{height:"100px", margin:"60px"}}/>
